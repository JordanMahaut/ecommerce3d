...
async function sendResetPasswordEmail(email, token) {
  ...
  await transporter.sendMail({
    from: process.env.MAIL_FROM,
    to: email,
    subject: "🔒 Réinitialisation de votre mot de passe - Ecommerce3D",
    html: `
<!DOCTYPE html>
<html lang="fr">
<head>
...
<tr>
<td style="background:linear-gradient(135deg,#dc2626,#ea580c);padding:40px;text-align:center;">

<h1 style="color:white;margin:0;font-size:32px;">
🔒 Ecommerce3D
</h1>

<p style="color:#fde68a;font-size:16px;margin-top:12px;">
...
<p style="color:#4b5563;font-size:16px;line-height:28px;">
Si cette demande vient bien de vous, cliquez sur le bouton ci-dessous.
</p>
...
© ${new Date().getFullYear()} Ecommerce3D
</p>
